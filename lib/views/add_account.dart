            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "Add account",
                    style: tS("NunitoBold", tm * 3.2, FontWeight.normal,
                        Colors.black),
                  ),
                  SizedBox(
                    height: hm * 5,
                  ...
                  TextFormField(
                    ...
                    style: tS('NunitoRegular', tm * 2, FontWeight.normal,
                        Colors.black),
                    onChanged: (val) {
                      provider.setAccount(val);
                    },
                    decoration: InputDecoration(
                      prefixIcon: titleController.value.text != null
                          ? Padding(
                              ...
                              child: SizedBox(
                                  ...
                                  child: Image.asset(
                                    provider
                                        .getIcon(titleController.value.text),
                                    height: hm * 3,
                                    width: hm * 2,
                                    fit: BoxFit.fill,
                                  )),
                      ...
                      hintText: "Title",
                      hintStyle: tS('NunitoRegular', tm * 2, FontWeight.normal,
                      ...
                      errorBorder: UnderlineInputBorder(
                        borderSide:
                            BorderSide(color: Colors.red, width: wm * 0.4),
                      ),
                      focusedErrorBorder: UnderlineInputBorder(
                        borderSide:
                            BorderSide(color: Colors.red, width: wm * 0.4),
                      ),
                      errorStyle: tS('NunitoRegular', tm * 2, FontWeight.normal,
                          Colors.red),
                    ),
                  ),
                  SizedBox(
                  ...
                  primaryButton(
                      ...
                      widget: Text(
                        "Create",
                        style: tS('NunitoBold', tm * 2.2, FontWeight.normal,
                            Colors.white),
                      ),
                      function: () async {
                        Account model = Account(
                            ...
                            icon: provider.getIcon(titleController.value.text));
                        if (await context
