...
class AddPassword extends StatefulWidget {
  ...
  const AddPassword({Key? key, required this.fromScreen}) : super(key: key);
...
class _AddPasswordState extends State<AddPassword> {
  ...
  checkAuth() async {
    if (widget.fromScreen == "checkAuth") {
      print("check auth");
      if (await context.read<AuthProvider>().biometricAuth()) {
        print("auth success");
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              Text(
                'Password',
                style: tS('NunitoBold', tm * 3, FontWeight.bold, Colors.black),
              ),
              SizedBox(
                height: hm * 1.8,
              ),
              Text(
                'Add password to continue',
                style: tS(
                    'NunitoRegular', tm * 2.5, FontWeight.normal, Colors.black),
              ),
              Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      /** Login button**/
                      roundedTextField(
                          context, wm, hm, tm, passwordController, "Password"),
                      SizedBox(
                        height: hm * 4,
                      ),
                      widget.fromScreen == "login"
                          ? roundedTextField(context, wm, hm, tm,
                      ...
                      Padding(
                        ...
                        child: primaryButton(
                            ...
                            widget: Center(
                              child: Text(
                                'Continue',
                                style: tS('NunitoRegular', tm * 2.2,
                                    FontWeight.bold, Colors.white),
                              ),
                            ),
                            function: () async {
                              if (widget.fromScreen == "chackAuth" && noAuth) {
                                if (await provider
                                  ...
                                  Popup(context, "Ok",
                                      ...
                                      description:
                                          "this password is wrong , please try another");
                                }
                              } else {
